...
return array(
     ...
     * 4.页面文件-- 必须使用前缀 `page.`, 如： `page.pages.analytics` 对于 `administrator/pages/analytics` 或者
     *               是 `administrator/pages/analytics.blade.php`，两种后缀都可以
     *
     *
     * 示例：
     * [
    ...
    /*
     *
     * 使用 bool 值来设定是否使用后台主页面
     *
     * 如值为 `true` ，将使用 `dashboard_view` 定义的视图文件来渲染页面；
     * 如值为 `false`, 将使用 `home_page` 定义的菜单条目来作为后台主页面
     */
    'use_dashboard' => false,
